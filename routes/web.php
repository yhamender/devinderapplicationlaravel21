...
Route::post('/send_mail', function () {
         $data = request()->all();
         $from=array();
         $from['address']= 'info@test.com';
         $from['name']='PPcabs';
         $from['email_to']= 'radha_jeetu@yahoo.com';
         
         Mail::send('mail',$data,function ($message) use ($from) {
           $message->from($from['address'],$from['name']);
           $message->to($from['email_to']);
           $message->subject('PPcabs: Drop us a Message');
           echo "Mail senn Successfully";
