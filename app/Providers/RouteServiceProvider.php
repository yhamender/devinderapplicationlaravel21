...
class RouteServiceProvider extends ServiceProvider
{
    ...
    {
        Route::group([
            'middleware' => ['cors','web', 'admin', 'auth:admin'],
            'prefix' => 'admin',
            'as' => 'admin.',
    ...
    {
        Route::group([
            'middleware' => ['cors','web', 'provider', 'auth:provider'],
            'prefix' => 'provider',
            'as' => 'provider.',
            'namespace' => $this->namespace,
        ], function ($router) {
    ...
    {
        Route::group([
            'middleware' => ['cors','web', 'dispatcher', 'auth:dispatcher'],
            'prefix' => 'dispatcher',
            'as' => 'dispatcher.',
            'namespace' => $this->namespace,
        ], function ($router) {
    ...
    {
        Route::group([
            'middleware' => ['cors','web', 'fleet', 'auth:fleet'],
            'prefix' => 'fleet',
            'as' => 'fleet.',
            'namespace' => $this->namespace,
        ], function ($router) {
    ...
    {
        Route::group([
            'middleware' => ['cors','web', 'account', 'auth:account'],
            'prefix' => 'account',
            'as' => 'account.',
            'namespace' => $this->namespace,
        ], function ($router) {
